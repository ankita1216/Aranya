      ...
      {isOpen && (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
          ...
          >
            ...
            <button
              onClick={onClose}
              className="absolute right-6 top-6 z-20 p-2 text-[#1f4d3f] transition-transform hover:rotate-90"
            >
              <X size={24} />
            </button>
            ...
            <div className="flex flex-col max-h-[90vh]">
              ...
              <div className="p-8 pb-4 pt-12 md:p-10 md:pb-6 md:pt-16 text-center">
                <h1
                  ...
                  style={{ color: '#1f4d3f', fontWeight: 'bold' }}
                >
                  Enquire Now
                </h1>
              ...
              <div className="flex-1 overflow-y-auto no-scrollbar p-8 pt-0 md:p-10 md:pt-0">
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[9px] font-bold uppercase tracking-widest text-[#1f4d3f]/60 ml-1">Name</label>
                    <input
                      required
                      type="text"
                      placeholder="Enter your name"
                      className="w-full rounded-xl border border-[#1f4d3f]/10 bg-white px-5 py-3.5 text-sm text-black placeholder:text-black/50 outline-none transition-colors focus:border-[#C9A44D]"
                      value={formData.name}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="flex flex-col gap-1.5">
                      <label className="text-[10px] font-bold uppercase tracking-widest text-[#1f4d3f]/60 ml-1">Phone No</label>
                      <input
                        required
                        type="tel"
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label className="text-[10px] font-bold uppercase tracking-widest text-[#1f4d3f]/60 ml-1">Email</label>
                      <input
                        required
                        type="email"
                  ...
                  {/* <div className="flex flex-col gap-1.5">
                  <label className="text-[10px] font-bold uppercase tracking-widest text-[#1f4d3f]/60 ml-1">Message</label>
                  <textarea
                    placeholder="Your message (optional)"
                    rows={2}
                    className="w-full rounded-xl border border-[#1f4d3f]/10 bg-white px-5 py-3 text-sm text-black placeholder:text-black/50 outline-none transition-colors focus:border-[#C9A44D] resize-none"
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.99 }}
                    type="submit"
                    className="mt-4 w-full rounded-xl bg-[#1f4d3f] py-4 text-[10px] font-bold uppercase tracking-[0.2em] text-white shadow-xl transition-colors hover:bg-[#1f4d3f]"
                  >
                    Confirm Interest
                  </motion.button>
                </form>
